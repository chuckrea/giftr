...
describe Poll do
  describe 'given two Polls saved to our DB...' do
    before do
      @user1 = User.create!(email: "user@example.com", password: "abcd1234")
    ...
    describe 'given voters for a poll' do
      before do
        ...
        vote1 = Vote.create!(poll_id: @first_poll.id, user_id: @voter1.id)
        vote2 = Vote.create!(poll_id: @first_poll.id, user_id: @voter2.id)
      end
